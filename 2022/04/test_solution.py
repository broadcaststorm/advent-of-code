#!/usr/bin/env python3
"""
2022/04/test_solution.py: pyunit test file for solution
"""
...
def test_part1_sample(input_file_name="sample-part1.txt", result=2):
    """
...
def test_part2_sample(input_file_name="sample-part1.txt", result=4):
    """
